        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <p className="text-xs text-center text-gray-600">Admin Demo:</p>
                <p className="text-xs text-center text-gray-900">admin@example.com</p>
                <p className="text-xs text-center text-gray-900">admin123</p>
              </div>
              <div>
                <p className="text-xs text-center text-gray-600">User Demo:</p>
                <p className="text-xs text-center text-gray-900">user@example.com</p>
                <p className="text-xs text-center text-gray-900">password123</p>
              </div>
            </div>
          </div>
        </div>
